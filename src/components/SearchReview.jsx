...
const SearchReview = () => {
  ...
  const readValue = () => {
    axios
      .post("http://localhost:8080/search", data)
      .then((response) => {
              ...
              {result.map((value, index) => {
                return (
                  <div className="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3">
                    <div class="card">
                      <img
                        src="https://imgs.search.brave.com/y2-fulDZ_bDajuniMH32jYctvLHccHn3UQL2IVwfYUU/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9tLm1l/ZGlhLWFtYXpvbi5j/b20vaW1hZ2VzL00v/TVY1Qk1qQTVOREk1/T1Rnek5WNUJNbDVC/YW5CblhrRnRaVGd3/TmpnMk56TXlNVEVA/LmpwZw"
                        class="card-img-top"
                        alt="..."
                      />
